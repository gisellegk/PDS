...
_start:
	...
	movia	r20, HEX5_HEX4_BASE	# HEX5_HEX4 base address
	movia	r18, HEX_bits
	ldwio	r6, 0(r18)			# load pattern for HEX displays
...
NO_BUTTON:
	...
	stwio	r6, 0(r20) 			# store to HEX5 ... HEX4
	roli	r6, r6, 1			# rotate the displayed pattern

	movia	r7, 2000000			# delay counter
DELAY:	
	subi	r7, r7, 1
	bne		r7, r0, DELAY	
